namespace CatechistHelper.Domain.Constants
{
    public static class ApiEndPointConstant
    {
        ...
        public static class Account
        {
            ...
            public const string CalendarEndPoint = AccountEndPoint + "/calendar";
        }
        ...
        public static class Catechist
        {
            ...
            public const string TrainingOfCatechistEnpoint = CatechistEndpoint + "/training";
        }
        ...
        public static class Class
        {
            ...
            public const string UpdateSlotEndpoint = ApiEndpoint + "/slots" + ByIdRoute;
        }
        ...
        public static class CatechistInSlots
        {
            ...
            public const string CatechistInSlotFindEndpoint = CatechistInSlotEndpoint + "/find";
        }
